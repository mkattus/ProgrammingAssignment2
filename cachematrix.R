...
## its inverse, and cache the inverse. Caching the inverted matrix avoids having to recalculate the 
## inverse (a costly computation) if the inverse is called after the initial calculation.       
